            ...
            <section className="guide-section">
                ...
                <div className="guide-card-grid">
                    ...
                    <div className="guide-card">
                        ...
                        <h3>靈感待辦 (Pending)</h3>
                        <p>這是一個非線性的創意空間。所有「未安排日期」的任務都會出現在這裡，適合存放突如其來的靈感或隨手記下的待辦事項。</p>
                    </div>

                    <div className="guide-card">
                        <div className="card-icon"><i className="ri-bar-chart-fill"></i></div>
                        <h3>數據洞察 (Insights)</h3>
                        <p>視覺化您的生產力。透過圖表分析任務完成趨勢、類別分佈與優先級比例，助您優化時間分配。</p>
                    </div>
                </div>
            </section>
            ...
            <section className="guide-section flow-section">
                ...
                <div className="flow-content">
                    <div className="flow-step">
                        ...
                        <h4>靈感捕捉</h4>
                        <p>在「我的任務」切換至「靈感待辦」分頁，隨手新增不限日期的靈感。</p>
                    </div>
                    <div className="flow-connector"><i className="ri-arrow-right-line"></i></div>
                    <div className="flow-step">
                        <span className="step-num">2</span>
                        <h4>時間分配</h4>
                        <p>編輯任務並賦予其「日期」，任務將自動移動至「月曆」與「我的任務」的「已排程」分頁。</p>
                    </div>
                    <div className="flow-connector"><i className="ri-arrow-right-line"></i></div>
                    <div className="flow-step">
                        <span className="step-num">3</span>
                        <h4>進度管理</h4>
                        <p>在「看板視圖」中切換狀態，並在「數據洞察」中檢視您的成長軌跡。</p>
                    </div>
                </div>
            </section>

            <section className="guide-section tip-section">
                <h2><i className="ri-keyboard-line"></i> 全域快捷鍵 (Keyboard Shortcuts)</h2>
                <div className="shortcuts-grid">
                    <div className="shortcut-item"><kbd>1</kbd> ~ <kbd>4</kbd><span>快速切換視圖</span></div>
                    <div className="shortcut-item"><kbd>N</kbd><span>新增任務</span></div>
                    <div className="shortcut-item"><kbd>/</kbd><span>聚焦搜尋框</span></div>
                    <div className="shortcut-item"><kbd>T</kbd><span>回今日 (月曆)</span></div>
                    <div className="shortcut-item"><kbd>Esc</kbd><span>關閉彈窗 / 取消</span></div>
                </div>
            </section>
            ...
            <section className="guide-section tip-section">
                ...
                <div className="tips-list">
                    <div className="tip-item">
                        <strong>快速新增：</strong> 在月曆上連按兩下，系統會自動填入該日期的預設值。快捷鍵「N」可隨時喚起表單。
                    </div>
                    <div className="tip-item">
                        <strong>NLP 智慧：</strong> 在標題中使用 `!h` (高優先)、`#work` (類別)、`@14:00` (時間) 即可快速解析任務屬性。
                    </div>
                    <div className="tip-item">
                        <strong>自動存檔：</strong> 您的每一筆異動都會即時同步到本地 IndexedDB，無需手動點擊，保證效能與數據安全。
                    </div>
                    <div className="tip-item">
