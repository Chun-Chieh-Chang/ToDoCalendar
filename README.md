...
- **當前版本**: v1.2.0
- **最後更新**: 2026-01-13
- **相容性**: Chrome, Edge, Safari, Firefox (網頁版); Windows 10/11 (桌面版)
- **部署地址**: [ToDoCalendar 網頁版](https://Chun-Chieh-Chang.github.io/ToDoCalendar/)

## 🚀 最新更新 (v1.2.0)

- ✅ **新增網頁版部署**：支援透過 GitHub Pages 在瀏覽器中使用
- ✅ **多人使用支援**：每位使用者的資料獨立儲存在各自的瀏覽器中
- ✅ **隱私保護**：所有個人任務資料僅儲存在使用者的電腦本機 (`localStorage`)，不會上傳至伺服器
- ✅ 新增年份和月份下拉選單功能
- ✅ 改善日曆網格在淺色主題下的可見性
- ✅ 修復 TypeScript 類型錯誤
- ✅ 優化響應式設計
